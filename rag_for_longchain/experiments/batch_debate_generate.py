...
if __name__ == "__main__":
    # ========== 按需修改你的路径 ==========
    input_dir = r"D:\converstional_rag\23acldata\input_data\processed_input"
    output_file = r"D:\converstional_rag\23acldata\output_data\debaterRAG\debates_output_without_logic.json"
